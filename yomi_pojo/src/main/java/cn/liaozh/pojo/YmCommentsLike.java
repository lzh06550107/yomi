...
public class YmCommentsLike implements Serializable {
    ...
    public YmCommentsLike setLikeId(final String likeId) {
        this.likeId = likeId;
        return this;
    }

    public YmCommentsLike setUserId(final String userId) {
        this.userId = userId;
        return this;
    }

    public YmCommentsLike setCommentId(final String commentId) {
        this.commentId = commentId;
        return this;
    }

    public YmCommentsLike setLikeState(final String likeState) {
        this.likeState = likeState;
        return this;
    }

    public YmCommentsLike setCreateTime(final String createTime) {
        this.createTime = createTime;
        return this;
    }

    public YmCommentsLike setUpdateTime(final String updateTime) {
        this.updateTime = updateTime;
        return this;
    }

    public String toString() {
        return "YmCommentsLike(likeId=" + this.getLikeId() + ", userId=" + this.getUserId() + ", commentId=" + this.getCommentId() + ", likeState=" + this.getLikeState() + ", createTime=" + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ")";
    }

    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof YmCommentsLike)) {
            return false;
        } else {
            YmCommentsLike other = (YmCommentsLike)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof YmCommentsLike;
    }
