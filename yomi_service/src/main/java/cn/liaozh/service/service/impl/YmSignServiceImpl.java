...
public class YmSignServiceImpl extends MPJBaseServiceImpl<YmSignMapper, YmSign> implements YmSignService {
    ...
    public YmSign findSignListByUserId(String userId) {
        ...
        ((QueryWrapper)queryWrapper.like("sign_in_date", todayStr)).eq("user_id", userId);
        YmSign ymSign = (YmSign)((YmSignMapper)this.baseMapper).selectOne(queryWrapper);
        return ymSign == null ? new YmSign() : (YmSign)((YmSignMapper)this.baseMapper).selectOne(queryWrapper);
    }
    ...
    public void postSignIn(String userId) {
        ...
        if (!userId.equals(signListByUserId.getUserId())) {
            ...
            ((YmSignMapper)this.baseMapper).insert(sign);
        }
    }
    ...
    public YmSign findSignByUserId(String userId) {
        ...
        YmSign ymSign = (YmSign)((YmSignMapper)this.baseMapper).selectOne(wrapper);
        return ymSign;
    }
    ...
    public YmSign IsTime(String userId) {
        ...
        QueryWrapper<YmSign> queryWrapper = new QueryWrapper();
        ((QueryWrapper)((QueryWrapper)queryWrapper.eq("user_id", userId)).gt("sign_in_date", fifthMinute)).lt("sign_in_date", lastMinute);
        YmSign one = (YmSign)((YmSignMapper)this.baseMapper).selectOne(queryWrapper);
        return one;
    }
    ...
    public YmSign findSignCount(String userId) {
        ...
        Integer integer = ((YmSignMapper)this.baseMapper).selectCount(wrapper);
        ...
        YmCarouselFigure entity = (YmCarouselFigure)this.ymCarouselFigureService.getOne(lambdaQueryWrapper);
